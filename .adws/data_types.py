"""Data types for GitHub API responses and agent providers.
...
# Agent model names — varies by provider:
#   opencode/claude_cli: "sonnet" or "opus"
#   venice_api: any Venice model ID (e.g. "zai-org-glm-5-1")
AgentModel = str

# Supported slash commands for issue classification
# These should align with your custom slash commands in .opencode/commands
...
class AgentPromptRequest(BaseModel):
    """Agent prompt configuration (works with any provider)."""
...
class AgentPromptResponse(BaseModel):
    """Agent response (works with any provider)."""
...
class AgentTemplateRequest(BaseModel):
    """Agent template execution request (works with any provider)."""
