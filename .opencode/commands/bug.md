...
Focus on the following files (discover actual paths from manifest.yml or AGENTS.md Navigation):
- `README.md` - Contains the project overview and instructions.
- Source code directory - Main application code (discover from manifest.yml `paths.source` or AGENTS.md)
- Test directory - Test suites (discover from manifest.yml `paths.tests` or AGENTS.md)
- Scripts directory - Build and deployment scripts (discover from manifest.yml `paths.scripts` or AGENTS.md)
...
- Use the test command from AGENTS.md Development Commands > Validation section
- If no test command is documented, discover and run the appropriate test runner for the project's language/framework
